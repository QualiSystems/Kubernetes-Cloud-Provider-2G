...
### Kubernetes Cloud Provider Shell 2G
Kubernetes Cloud Provider Shell 2G provides you with apps deployment and management capabilities. 
...
|:---|:---|:---|
|VM Size|String|The Kubernetes VM Size. The VM Size determines the CPU, memory, disk size and networking capacity of the VM. For example: “Standard_A1_v2”|
...
This section describes how to import the Kubernetes Cloud Provider Shell 2G shell and configure and modify the shell’s devices.
...
_**Kubernetes Cloud Provider Shell 2G requires you to create an appropriate App template, which would be deployed as part of the sandbox reservation. For details, see the following CloudShell Help article: [Applications' Typical Workflow](https://help.quali.com/Online%20Help/0.0/Portal/Content/CSP/MNG/Mng-Apps.htm?Highlight=App#Adding)**_
